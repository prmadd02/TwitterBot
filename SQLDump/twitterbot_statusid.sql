...
CREATE TABLE `statusid` (
  `ZipFirstID` bigint(20) unsigned DEFAULT NULL,
  `ZipLastID` bigint(20) unsigned DEFAULT NULL,
  `WeaFirstID` bigint(20) unsigned DEFAULT NULL,
  `WeaLastID` bigint(20) unsigned DEFAULT NULL
